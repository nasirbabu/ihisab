...
class MenuSiteController extends BackEndController {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('MenuSite');
    ...
    public function actionAdmin() {
        $model = new MenuSite('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MenuSite'])) {
            $model->attributes = $_GET['MenuSite'];
        }
     ...
     * @return MenuSite the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = MenuSite::model()->findByPk($id);
        if ($model === null) {
     ...
     * @param MenuSite $model the model to be validated
     */
