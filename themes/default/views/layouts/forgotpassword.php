...
<html lang="en-us">
    ...
    <body id="login" class="animated fadeInDown">
        <header id="header">
            <!--<span id="logo"></span>-->
            <div id="logo-group">
                <span id="logo"> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo.png" alt="<?php echo CHtml::encode(Yii::app()->name); ?>"> </span>
                <!-- END AJAX-DROPDOWN -->
            </div>            
        </header>
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/plugin/smartclick/smartclick.js"></script>
        <!--[if IE 7]>
