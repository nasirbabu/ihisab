    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
            <div class="well no-padding">
                ...
                <fieldset>
                    <section>
                        <?php echo $forms->errorSummary($form, '<i class="fa fa-bell text-danger"></i> Please fix the following input errors:', '', array('class' => 'text-danger', 'style' => 'padding-left:10px;')); ?>
                    </section>
                    <section>
                        <label class="label">Username/E-mail</label>
                        <label class="input"> <i class="icon-append fa fa-user"></i>
                            <?php echo $forms->textField($form, 'login_or_email'); ?>
                            <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Please enter email address/username</b></label>
                        <div class="note">
                            <?php echo CHtml::link('I remembered my password!', array('/site/login')); ?>
                        </div>
                    </section>
                </fieldset>
                <footer>
