...
if ($model->transaction_type == 3) {
    $pieces = explode(",", $model->account);
    $model->account = $pieces[0];
    $model->AccountTo = $pieces[1];
}
?>
<div class="modal-header">
    ...
    <h4 class="modal-title" id="editTransactionLabel">EDIT TRANSACTION</h4>
</div>
<div class="modal-body">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo $form->dropDownList($model, 'account', CHtml::listData(Account::model()->findAll(array('condition' => 'user=' . Yii::app()->user->id)), 'id', 'account_name'), array('class' => 'select2')); ?>
